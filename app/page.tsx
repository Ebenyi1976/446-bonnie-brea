        ...
        <div className="wrap">
          ...
          <div className="grid6">
            {[
              ...
              { stat: 'Owner Unit', title: 'Delivered Vacant at Close', body: 'Owner-occupied unit delivers vacant at close of escrow. Only 3 RSO units require relocation — not 4. Less cost. Less time. Less complexity.*' },
