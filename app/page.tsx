        ...
        <div className="wrapNarrow">
          ...
          <div className="arrowList">
            {[
              ...
              { title: 'The RSO Picture', badge: 'Fully Disclosed', badgeCls: 'badgeGold', body: 'Three RSO tenants transfer with the property. Owner unit delivered vacant. Move-in dates confirmed.' },
        ...
        <div className="wrap">
          ...
          <div className="grid6">
            {[
              ...
              { stat: 'RSO', title: 'Fully Disclosed — No Surprises', body: 'Three RSO tenants disclosed with confirmed move-in dates. Owner unit delivered vacant at COE.' },
