        ...
        <div className="wrap">
          ...
          <div className="grid6">
            {[
              ...
              { stat: '329 S Bonnie Brae', title: 'Same Street — Final Phase', body: '329 S Bonnie Brae St — a 30-unit multifamily project on this exact street is now in final construction phase. The submarket is not coming. It is already here.' },
              { stat: '452 S Bonnie Brae', title: 'Next Door — Permits Active', body: '452 S Bonnie Brae St — the adjacent property just reactivated building, grading, and shoring permits. A 30-unit 6-story development is in active plan check steps from this site. The block is already moving.' },
              { stat: '451 S Bonnie Brae', title: 'Across the Street — LOD Issued', body: '451 S Bonnie Brae St — City of LA issued Letter of Determination DIR-2016-4972-DB supporting a 26-unit project directly across the street. Same zoning. Same TOC tier.' },
            ].map(({ stat, title, body }) => (
